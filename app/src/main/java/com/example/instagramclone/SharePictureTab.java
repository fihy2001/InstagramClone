            ...
            case R.id.btnShareImage:
                if (receivedImageBitmap != null){
                    ...
                    if (edtImageDescription.getText().toString().equals("")){
                        FancyToast.makeText(getContext(), "Description is required", FancyToast.LENGTH_SHORT, FancyToast.ERROR, false).show();
                    ...
                    FancyToast.makeText(getContext(), "Image is required", FancyToast.LENGTH_SHORT, FancyToast.ERROR, false).show();
                }
            break;
