...
public class SignUp1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(SignUp1.this);
                    ...
                    public void done(List<ParseObject> objects, ParseException e) {
                        if (e == null){
                            if (objects.size() > 0){
                                ...
                                FancyToast.makeText(SignUp1.this,  allKickBoxers, FancyToast.LENGTH_SHORT, FancyToast.SUCCESS, false).show();
                            }
                            else {
                                FancyToast.makeText(SignUp1.this, e.getMessage(), Toast.LENGTH_LONG, FancyToast.ERROR, false).show();
                            }
                        }
                    }
                });
        ...
        try {
            ...
            kickboxer.saveInBackground(new SaveCallback() {
                ...
                public void done(ParseException e) {
                    if (e == null) {
                        FancyToast.makeText(SignUp1.this, kickboxer.get("name") + " saved successfully", FancyToast.LENGTH_SHORT, FancyToast.SUCCESS, false).show();
                    } else {
                        FancyToast.makeText(SignUp1.this, e.getMessage(), Toast.LENGTH_LONG, FancyToast.ERROR, false).show();
                    }
                }
